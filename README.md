...
* На репозиторий не загружены файлы `db.sqlite` и часть картинок из папки `media`. Это нарочно так, потому что GitHub не обрабатывает файлы размером более 100 Мб
